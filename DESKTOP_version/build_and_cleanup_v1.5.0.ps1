# ============================================================
#  cURL-to_GET-converter  v1.5.0  —  build + cleanup
# ============================================================
#  Run this on WINDOWS (double-click build_and_cleanup_v1.5.0.bat,
#  or right-click this .ps1 -> Run with PowerShell).
#
#  What it does:
#    1. builds  cURL-to_GET-converter_1.5.0.exe  with PyInstaller
...
Write-Host ''
Write-Host '=== cURL-to_GET-converter v1.5.0 — build ===' -ForegroundColor Cyan
...
& $py -m PyInstaller --clean --noconfirm 'cURL-to_GET-converter_1.5.0.spec'
if ($LASTEXITCODE -ne 0) { throw 'PyInstaller build failed.' }

# --- move the produced .exe next to main.py ---
$built  = Join-Path $root 'dist\cURL-to_GET-converter_1.5.0.exe'
$target = Join-Path $root 'cURL-to_GET-converter_1.5.0.exe'
...
Write-Host ''
Write-Host '=== Done. v1.5.0 .exe is ready. ===' -ForegroundColor Green
Write-Host ''
